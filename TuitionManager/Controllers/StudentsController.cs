...
namespace TuitionManager.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        // GET: api/Students
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Students>>> GetStudentsTb()
        {
            return await _context.StudentsTb.ToListAsync();
        }
        ...
        {
            var students = await _context.StudentsTb.FindAsync(id);
        ...
        {
            _context.StudentsTb.Add(students);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteStudents(int id)
        {
            ...
            _context.StudentsTb.Remove(students);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.StudentsTb.Any(e => e.ID == id);
        }
    }
}
